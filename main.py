...
class Game:
    ...
    def give_instructions(self):
        print(f'''\n Wordle is a single player game. 
              ...
              Your progress guide "{tcol.OKCYAN}{tcol.BOLD}A{tcol.ENDC}{tcol.UNDERLINE}A{tcol.ENDC}{tcol.UNDERLINE}A{tcol.ENDC}{tcol.OKCYAN}{tcol.BOLD}A{tcol.ENDC}{tcol.FAIL}{tcol.BOLD}A{tcol.ENDC}"
